...
- [如何写一个babel](#如何写一个babel)
  - [前言](#前言)
  - [前置](#前置)
  - [代码解析](#代码解析)
    - [parser 概念](#parser-概念)
    - [词法分析(Tokenizer -- 词法分析器)](#词法分析tokenizer----词法分析器)
      - [1.3 语法分析](#13-语法分析)
  - [代码转换](#代码转换)
    - [如何转换代码?](#如何转换代码)
    - [遍历抽象语法树(实现遍历器traverser)](#遍历抽象语法树实现遍历器traverser)
    - [转换代码(实现转换器transformer)](#转换代码实现转换器transformer)
  - [生成代码(实现生成器generator)](#生成代码实现生成器generator)
  - [最后](#最后)
