...
<div align="center"><img :src="$withBase('/images/node/list.png')" alt="node/list.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/listfanzhuan.png')" alt="node/listfanzhuan.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/listxunhuan.png')" alt="node/listxunhuan.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/4.e885222e.png')" alt="node/4.e885222e.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/5.5e323416.png')" alt="node/5.5e323416.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/6.29.png')" alt="node/6.29.png"></div>
...
<div align="center"><img :src="$withBase('/images/node/7.ee.png')" alt="node/7.ee.png"></div>
