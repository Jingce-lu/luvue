...
<img :src="$withBase('/images/react/long-task.png')" alt="长任务">
...
<img  :src="$withBase('/images/react/legacy-move.gif')" alt="同步">

作为对比，再点击“设置”面板中的“Siri 与搜索”，进入“Siri 与搜索”界面：

<img  :src="$withBase('/images/react/concurrent-mov.gif')" alt="异步">
