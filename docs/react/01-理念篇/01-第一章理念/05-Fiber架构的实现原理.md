...
在[新的 React 架构一节](../preparation/newConstructure.md)中，我们提到的**虚拟 DOM**在`React`中有个正式的称呼——`Fiber`。在之后的学习中，我们会逐渐用`Fiber`来取代**React16 虚拟 DOM**这一称呼。
...
对应的`Fiber树`结构：
<img :src="$withBase('/images/react/fiber.png')" alt="Fiber架构">
