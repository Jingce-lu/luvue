...
<img :src="$withBase('/images/react/rootfiber.png')" alt="rootFiber">
...
<img :src="$withBase('/images/react/workInProgressFiber.png')" alt="workInProgressFiber">
...
<img :src="$withBase('/images/react/wipTreeFinish.png')" alt="workInProgressFiberFinish">

## update 时

1. 接下来我们点击`p节点`触发状态改变，这会开启一次新的`render阶段`并构建一棵新的`workInProgress Fiber 树`。

<img :src="$withBase('/images/react/wipTreeUpdate.png')" alt="wipTreeUpdate">
...
<img :src="$withBase('/images/react/currentTreeUpdate.png')" alt="currentTreeUpdate">
...
[关注公众号](../me.html)，后台回复**812**获得在线 Demo 地址
