...
在[Hooks 数据结构一节](./structure.html#memoizedstate)我们讲到：
...
> 你可以在[ReactSideEffectTags 文件](https://github.com/facebook/react/blob/1fb18e22ae66fdb1dc127347e169e73948778e5a/packages/react-reconciler/src/ReactSideEffectTags.js#L24)中看到`ref`对应的`effectTag`
...
在[mutation 阶段一节](renderer/mutation.html#commitmutationeffects)我们讲到
...
接下来进入`ref`的赋值阶段。我们在[Layout 阶段一节](../renderer/layout.html#commitlayouteffects)讲到
