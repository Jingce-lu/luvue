...
<div align="center"><img :src="$withBase('/images/vuesourcecode/lifecycle.png')" alt="vuesourcecode/lifecycle.png"></div>
...
> 这里为了更加直观，采用最简单的方法来实现，调用钩子，并修改应用状态
...
<div align="center"><img :src="$withBase('/images/vuesourcecode/flow.png')" alt="vuesourcecode/flow.png"></div>
